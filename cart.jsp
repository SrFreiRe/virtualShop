        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            <%@ page isELIgnored="false" %>
                ...
                <body>
                    <div class='container'>
                        <header>
                            <h1 style='font-weight:700;letter-spacing:-1px;'>🛒 Your Cart</h1>
                            <p class='subtitle' style='font-size:1.1em;'>Selected albums</p>
                        </header>
                        <table>
                            <tr>
                                <th>Album</th>
                            ...
                            <c:forEach var="item" items="${cart.items}" varStatus="status">
                                <tr>
                                    <td>${item.name}</td>
                                    <td>
                                        <fmt:formatNumber value="${item.price}" type="number" minFractionDigits="2" />$
                                    </td>
                                    <td>${item.quantity}</td>
                                    <td>
                        ...
                        <p style='text-align:center; font-size:1.2em;'><b>Total:
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <div
                                    style='text-align:center;color:#b388ff;font-size:1.15em;margin:28px 0 22px 0;font-weight:500;'>
                                    Your cart is empty.</div>
                            </c:otherwise>
                        </c:choose>
                        <div style='text-align:center; margin-top:18px;'>
                            <a href='index.html' style='color:#4f8cff;text-decoration:none;font-weight:bold;'>Continue
                                shopping 🎶</a>
                        </div>
                        <footer>
                            <hr>
